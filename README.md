...
この度はお忙しい中、アプリ概要をご覧頂き誠に有難うございます。本アプリには大きく分けて２つの機能がございます。一つはイベントの内容をカレンダーに反映させる機能。もう一つはお気に入り登録(相互フォロー)が出来る機能になっております。自身が気になっているユーザー(ファン同士)、もしくは応援しているアーティストをフォローする事で一覧からイベント内容を共有・確認が出来る仕組みになっております。フォロー機能を効率よく使って頂き、たくさんのアーティスト、ファン同士で友好関係を築いて欲しいという想いでアプリを作成しました。

たくさんの方にぜひ使って欲しいと願っております。本アプリの作成に至るまでの詳しい経緯については最後の方にまとめております。ご興味がありましたらぜひ一度ご確認下さい。よろしくお願い致します。
