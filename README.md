...
カレンダーからイベントの内容が共有が出来るアプリです。自身のイベント内容はもちろん、自身の好きなアーティストのライブ予定もお気に入り登録(フォロー)する事で知りたいイベント内容が簡単に閲覧出来るような仕組みになっています。お気に入り(フォロー)機能を駆使して、たくさんの友好関係を築いて頂き、気になった人のイベント内容がもし共有出来たらすごく便利なツールだと思いアプリを作成しました。たくさんの方にぜひ使って欲しいと思っております。
...
今回のアプリ作成に至る経緯についてですが、私をはじめ周りの友人や先輩方にライブ鑑賞を趣味としている方が非常に多かった事もあり、自身のライブ予定やイベント内容をカレンダーに反映したり、共有したりする事が出来ればすごく便利になるのではないかと思いアプリの作成に臨みました。また、アーティスト活動をされている方も同時に応援が出来るようにアーティスト枠も追加し、フォローをしていく事で自身のお気に入りアーティスト欄を作成し、活動内容やライブスケジュールの内容を閲覧出来るように工夫しました。アプリを作成する上で自身のレベルアップも目標に掲げていたので、自身が作ってみたいオリジナリティーを優先する形でアプリの作成に臨みました。数多のトライ＆エラーを繰り返しましたが、自分が作りたいアプリの仕様を無事に作り切る事が出来ました。
