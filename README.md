...
・ファン(ユーザー)、アーティストの登録する内容や発信する情報がそれぞれで違うと考えた為、アカウント登録を別々にした点  
・イベント作成した内容をカレンダーに反映させる事で内容を一目で分かりやすいようにした点  
・フォロー機能を追加した事で自身がフォロー(お気にり登録)したファン(ユーザー)、アーティストの情報、カレンダーの内容を閲覧出来るようにした点
