class User < ApplicationRecord
  ...
  has_many :passive_user_bookmarks, class_name: "Bookmark", foreign_key: "following_id", dependent: :destroy #follower_idの外部キー(following_id)
  ...
  has_many :back_artist_bookmarks, class_name: "Bookmark", foreign_key: "following_id", dependent: :destroy #followed_idの外部キー(following_id)
