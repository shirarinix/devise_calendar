class User < ApplicationRecord
  ...
  has_many :active_user_bookmarks, class_name: "Bookmark", foreign_key: "follower_id", dependent: :destroy # 外部キーはfollower_id
  has_many :passive_user_bookmarks, class_name: "Bookmark", foreign_key: "following_id", dependent: :destroy # 外部キーはfollowing_id
  ...
  has_many :followers, through: :passive_user_bookmarks, source: :follower # フォローされている人(自身がフォローされている人)
  has_many :followings, through: :active_user_bookmarks, source: :following # フォローしている人

  has_many :artist_followers, through: :back_user_bookmarks, source: :follower
